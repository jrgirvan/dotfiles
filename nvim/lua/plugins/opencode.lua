return {
  ...
  config = function()
    vim.cmd([[set <F29>=\e[46;5u]])

    vim.keymap.set({ "n", "t" }, "<leader>oo", function() require("opencode").toggle() end, { desc = "Toggle opencode" })
    vim.keymap.set({ "n", "t" }, "<F29>", function() require("opencode").toggle() end, { desc = "Toggle opencode" })
    ...
    vim.keymap.set({ "n", "t" }, vim.keycode("<C-s>"), function() require("opencode").toggle() end,            { desc = "Toggle opencode" })
