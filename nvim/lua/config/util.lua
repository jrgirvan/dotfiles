...
---@return boolean
function jg.has(feature)
  return vim.fn.has(feature) > 0
end

jg.nightly = jg.has("nvim-0.12")
jg.on_personal = vim.fn.getenv("USER") == "john"

---Determine if you're on an external monitor
---@return boolean
function jg.on_big_screen()
...
---@return nil
function jg.set_keymaps(lhs, rhs, mode, opts)
  opts = opts or {}
...
---@return nil
function jg.create_user_command(name, desc, command, opts)
...
---@return nil
function jg.create_autocmd(autocmd, opts)
  opts = opts or {}
