...
separator_module.create("weather_separator", "right")
...
SBAR.exec([[bash -c '
    while ! /Users/john.girvan/.local/bin/aerospace list-workspaces --all > /dev/null 2>&1; do sleep 0.5; done
